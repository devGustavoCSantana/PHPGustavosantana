    ...
    <?php
        ...
        $agenda = [
                'Guilherme' => [
                        ...
                        'Email'    => ["Guilherme.fdomingue1@senacsp.edu.br", "Guilhermefrancadomingues@outlook.com"],
        ...
        echo $agenda['Guilherme']['Data-nascimento'][0];
        echo"<hr>";
 
        // Agenda Bidimencional
        $agenda2 = [
            'Guilherme' => [ // linha-0    Profundidade - 0 |  Profundidade - 1
                    'Telefone'          => "(11)90000-0000" , "(11)91111-1111",     // Coluna-0
                    'Email'             => "Guilherme.fdomingue1@senacsp.edu.br",   // Coluna-1
                    'Data-nascimento'   => '23/05/2003'                             // Coluna-2
            ],                          // Profundidade - 0 |  Profundidade - 1
        ];
                //       Linha   |  Coluna
        echo $agenda2['Guilherme']['Email'];
        echo "<hr>";
